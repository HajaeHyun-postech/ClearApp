...
class RacketmenuHomepage extends StatelessWidget {
  ...
  final List<Widget> imagelist = [Image.asset('assets/images/badminton_play.png'),Image.asset('assets/images/userImage.png'),Image.asset('assets/images/supportIcon.png')];
