...
class CustomFilter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SelectionMenu<RacketMenu>(
      ...
      menuPositionAndSizeComponent: MenuPositionAndSizeComponent(builder: _menuPositionBuilder),
    ...
    static MenuPositionAndSize _menuPositionBuilder(MenuPositionAndSizeComponentData data){
    ...
    Widget itemBuilder( BuildContext context, RacketMenu menu, OnItemTapped onItemTapped,)
    {   
          return Material(
          color: ClearAppTheme.white,
          child: Row(
